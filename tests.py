...
class TestBooksCollector:
    ...
    def test_set_books_with_two_books_specific_genre(self):
        collector = BooksCollector()
        collector.add_new_book('Гордость и предубеждение и зомби')
        collector.set_book_genre('Гордость и предубеждение и зомби', 'Ужасы')
    ...
    def test_set_key_val_books_genre(self):
        collector = BooksCollector()
    ...
    def test_set_books_for_children(self):
        collector = BooksCollector()
        collector.add_new_book('Гордость')
        collector.set_book_genre('Гордость', 'Комедии')
        assert collector.get_books_for_children() == ['Гордость']
